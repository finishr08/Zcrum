...
const app = new Hono()
  ...
  .get("/:projectId/analytics", sessionMiddleware, async (c) => {
    ...
    const taskDifferenece = taskCount - lastMonthTasks.total;
    ...
    const thisMonthAssignedTasks = await databases.listDocuments(
      ...
      [
        Query.equal("projectId", projectId),
        Query.equal("assigneeId", member.$id), // Fixed `assigneId` typo
        Query.greaterThanEqual("$createdAt", thisMonthStart.toISOString()),
        Query.lessThanEqual("$createdAt", thisMonthEnd.toISOString()),
      ]
    );
    ...
    const incompletedTaskDifferenece =
    ...
    const completedTaskDifferenece =
    ...
    return c.json({
      data: {
        ...
        taskDifferenece,
        assignedTaskCount,
        assignedTaskDifferenece,
        incompletedTaskCount,
        incompletedTaskDifferenece,
        completedTaskCount,
        completedTaskDifferenece,
        overdueTaskCount,
        overdueTaskDifferenece,
      },
    });
  });
